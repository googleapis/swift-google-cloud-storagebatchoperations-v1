...
extension Clients {
  final class StorageBatchOperationsLogging: StorageBatchOperationsStub {
    let inner: any StorageBatchOperationsStub
    let logger: Logger

    public init(_ inner: any StorageBatchOperationsStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-storagebatchoperations-v1"
      logger[metadataKey: "gcp.client.service"] = "storagebatchoperations"
      logger[metadataKey: "gcp.experimental.swift.client"] = "StorageBatchOperations"
      self.inner = inner
      self.logger = logger
    }
